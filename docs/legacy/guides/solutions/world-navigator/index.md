...
## Introduction
This uses the components  and [](../../components/explorer) to create a world navigator.
...
| --- | --- | ---|
|<img style={{width:"64px"}} src="https://recipes.jumpto365.com/img/50x50.png"/> | [Data Export/Import Component](../../components/data-exporter) | |
|<img style={{width:"64px"}} src="https://recipes.jumpto365.com/img/50x50.png"/> | [Explorer Component](../../components/explorer) | |
|<img style={{width:"64px"}} src="https://recipes.jumpto365.com/img/50x50.png"/> | [Search Component](../../components/search) | |
|<img style={{width:"64px"}} src="https://jumpto365.com/resources/images/Icons/SharePoint%20New.png"/> | SharePoint List | List to store countries of the world |
|<img style={{width:"64px"}} src="https://blob.jumpto365.com/images/default/h/e/x/hexatown.com/m/matt@hexatown.com/2022/10/Power%20Apps.png-20221023-102329.png"/> | Power App | Power App to present the World |
...
- Set the Display property to "Edit"

```javascript title="ImportButton - Edit"
// Don't allow the button to be clicked if there is already data in the list
If(CountRows(Countries)>0,Disabled,Edit)
```

- Set the OnSelect value of the control to the following expression:

```javascript title="ImportButton - OnSelect"
...
Insert a Label and set the Text to:
```javascript title="Label - Text"
CountRows(Countries)
```
