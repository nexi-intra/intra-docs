...
$uploadedFile = GraphAPI `
  ...
  -method "PUT" `
  -url "https://graph.microsoft.com/v1.0/users/$env:SENDER_UPN/drive/root:/koksmat/apps/azure/$env:GRAPH_APPDOMAIN/$env:TARGET_APPID/app-connection.txt:/content" `
  -headers @{
...
APP_APPLICATION_ID=$env:TARGET_APPID
APP_APPLICATION_DOMAIN=$env:TARGET_DOMAIN
APP_APPLICATION_CERTIFICATE=$secret
