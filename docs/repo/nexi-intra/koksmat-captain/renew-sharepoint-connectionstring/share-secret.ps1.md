...
$uploadedFile = GraphAPI `
  ...
  -method "PUT" `
  -url "https://graph.microsoft.com/v1.0/users/$env:SENDER_UPN/drive/root:/koksmat/apps/azure/$env:GRAPH_APPDOMAIN/$env:TARGET_APPID/sharepoint-connection.txt:/content" `
  -headers @{
